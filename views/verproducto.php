                    ...
                    <div class="d-flex flex-lg-row flex-column">
                            ...
                            <div id="producto-slider" class="carousel slide carousel-fade" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="../img/<?php echo $libro['imagen']; ?>" alt="Imagen del Libro"
                                            class="d-block">
                                    </div>
                        ...
                        <div class="buy-detail col-md-8 ms-lg-5">
                            ...
                            <div class="d-flex flex-row align-content-center">
                                ...
                                <!-- Botón de Deseo -->
                                <button type="button" class="btn btn-outline-orange btn-wishlist ms-4"
                            ...
                            <div class="book-sub-title d-flex flex-row align-content-center mb-2">
                                <a class="link-primary" href="buscar.php?busqueda=<?php echo $libro['autor']; ?>">
                                    <?php echo $libro['autor']; ?> <i class="fa fa-user"></i> ,
                                </a>
                                <a class="link-primary"
                                    href="vercategoria.php?categoria=<?php echo $libro['categoria']; ?>">
                        ...
                        <div class="d-flex flex-column col-md-3">
                            ...
                            <div class="producto-detail d-flex flex-lg-row justify-content-lg-center mt-3 ">
                                ...
                                <div class="d-flex flex-column me-lg-0 ms-5">
                                    <p>
                                        <?php echo $libro['formato']; ?>
                                    </p>
                                    <p>
                                        <?php echo $libro['autor']; ?>
                                    </p>
                                    <p>
                                        <?php echo $libro['ano_publicacion']; ?>
                                    </p>
                                    <p>
